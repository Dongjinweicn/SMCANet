...
from inference_ori import infer
...
def main(args):
    ...
    model, criterion, visualizer = build_model(args) # DSU
    model.to(device)
    # TODO zhushi
    # logger.info(model)
    ...
    if args.eval:
        ...
        # test_df = visual(model, args.model, args.dataset,dataloader_val_dict, args.sequence,args.output_dir, device)
    else:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('SMCAnet training and evaluation', allow_abbrev=False)
